 ...
 * Date: 2026-09-06
 * Description: Form request for validating new user registration data.
 */
...
class RegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'license_number' => ['required', 'integer', 'min:1', 'unique:users,license_number'],
            'emergency_contact' => ['required', 'integer', 'min:1'],
            'identification_number' => ['required', 'integer', 'min:1', 'unique:users,identification_number'],
